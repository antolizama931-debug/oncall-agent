...
- [零基础入门指南](docs/零基础入门指南.md)：不要求运维、后端或 AI 基础，用一个网站故障的例子解释项目、页面、数据、RAG、Agent、会话记忆和常见术语。**第一次了解项目请先读这份。**
- [项目技术说明书](docs/项目技术说明书.md)：在读完入门指南后，进一步理解需求、架构、数据流、Agent 状态机、Hybrid RAG、上下文、安全、测试、部署和生产化路线。
- [大厂面试速查手册](docs/大厂面试速查手册.md)：包含 30 秒/2 分钟/5 分钟介绍、55 个高频问答、系统设计追问、STAR 表达和七天学习计划。

建议阅读顺序：零基础入门指南 → 实际操作一次事故 → 技术说明书 → 面试速查手册。面试时必须区分当前已实现的安全演练和规划中的生产自动修复。
